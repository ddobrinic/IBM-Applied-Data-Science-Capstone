...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        # Calculate the success and failure counts for the selected launch site
...
def update_payload_scatter_chart(entered_site, payload_range):
    if entered_site == 'ALL':
        # Scatter plot for all sites with selected payload range
        ...
        # Scatter plot for a specific site with selected payload range
        filtered_df = spacex_df[(spacex_df['Launch Site'] == entered_site) &
